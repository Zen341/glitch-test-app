            ...
            if (title && content) {
                ...
                content = sanitizeHtml(`${content}`.trim(), {
                    ...
                    allowedAttributes: {
                        ...
                        img: ['src', 'srcset', 'alt', 'title', 'width', 'height', 'loading', 'style', 'data-filename'] // Add extra attributes here
                    },
                    allowedSchemes: sanitizeHtml.defaults.allowedSchemes.concat(['data']) // Add 'data' scheme
            })
